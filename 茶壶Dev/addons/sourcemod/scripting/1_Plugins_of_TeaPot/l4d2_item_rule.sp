...
public void OnPluginStart()
{
	...
	//RegAdminCmd("sm_item_remove", Cmd_RemoveItem, ADMFLAG_ROOT);
...
// Action Cmd_RemoveItem(int client, int args){
// 	if(args != 1)
// 		return Plugin_Handled;
// 	char item[MAX_ITEMNAME_LEN];
// 	GetCmdArg(1, item, sizeof(item));
// 	g_smItemRemove.SetString(item);
