...
public void OnPluginStart()
{
	...
	g_hCvarNameChange 	= CreateConVar( PLUGIN_NAME ... "_name_change_player_suppress", 	"0", 	"If 1, Silence Player name Changes announcement including spectators.", CVAR_FLAGS, true, 0.0, true, 1.0);
