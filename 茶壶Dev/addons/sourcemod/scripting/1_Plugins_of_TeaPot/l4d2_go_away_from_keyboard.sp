...
public void OnPluginStart()
{
	...
	l4d2_timerkeyboard	= CreateConVar("l4d2_enabled_away_timer_keyboard", "0.0", "设置多少秒后才能再次使用休息.", FCVAR_NOTIFY);
	l4d2_timerSpecNext	= CreateConVar("l4d2_enabled_away_timer_specnext", "0.0", "设置多少秒后才能再加入幸存者.", FCVAR_NOTIFY);
