...
public void OnPluginStart()
{
	...
	g_hDeleteTimeDiff = CreateConVar("file_deleter_time_different", "2", "距离当前日期超过多少天的 Error log 会被删除", CVAR_FLAG, true, 0.0);
	g_hAllowLog = CreateConVar("file_deleter_allow_log", "0", "是否允许记录日志", CVAR_FLAG, true, 0.0, true, 1.0);
