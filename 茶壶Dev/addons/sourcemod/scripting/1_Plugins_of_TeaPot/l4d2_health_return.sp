...
public void OnPluginStart()
{
	...
	hCountKIHNumoff		= CreateConVar("l4d2_Kill_inf_Healthoff", "0", "启用击杀特感提示?(因为多特服特感太多,导致提示过于刷屏) 0=禁用, 1=启用.", FCVAR_NOTIFY);
	hCountKIHNumHead		= CreateConVar("l4d2_Kill_inf_health_Infected_head", "0", "击杀一个特感奖励多少血量(不包括坦克). 0=禁用击杀特感提示,血量和前置弹药奖励.", FCVAR_NOTIFY);
	hCountKIHNumShot		= CreateConVar("l4d2_Kill_inf_health_Infected_shot", "0", "爆头击杀一个特感奖励多少血量(不包括坦克). 0=禁用击杀特感提示,血量和前置弹药奖励.", FCVAR_NOTIFY);
	hCountPistolAmmoHead	= CreateConVar("l4d2_Kill_inf_health_ammo_Pistol_head", "0", "小手枪击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountPistolAmmoShot	= CreateConVar("l4d2_Kill_inf_health_ammo_Pistol_shot", "0", "小手枪爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountAutoshotAmmoHead	= CreateConVar("l4d2_Kill_inf_health_ammo_autoshotgun_head", "0", "连喷击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountAutoshotAmmoShot	= CreateConVar("l4d2_Kill_inf_health_ammo_autoshotgun_shot", "0", "连喷爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountChainsawHead		= CreateConVar("l4d2_Kill_inf_health_ammo_chainsaw_head", "0", "电锯击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountChainsawShot		= CreateConVar("l4d2_Kill_inf_health_ammo_chainsaw_shot", "0", "电锯爆头击杀一个特感奖励多少前置弹药(不包括坦克,好像电锯没有爆头判定). 0=禁用.", FCVAR_NOTIFY);
	hCountGrenadeAmmoHead	= CreateConVar("l4d2_Kill_inf_health_ammo_grenadelauncher_head", "0", "榴弹发射器击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountGrenadeAmmoShot	= CreateConVar("l4d2_Kill_inf_health_ammo_grenadelauncher_shot", "0", "榴弹发射器爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountHuntingAmmoHead	= CreateConVar("l4d2_Kill_inf_health_ammo_huntingrifle_head", "0", "猎枪击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountHuntingAmmoShot	= CreateConVar("l4d2_Kill_inf_health_ammo_huntingrifle_shot", "0", "猎枪爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountMagnumAmmoHead	= CreateConVar("l4d2_Kill_inf_health_ammo_pistol_magnum_head", "0", "马格南击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountMagnumAmmoShot	= CreateConVar("l4d2_Kill_inf_health_ammo_pistol_magnum_shot", "0", "马格南爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountRifleAmmoHead		= CreateConVar("l4d2_Kill_inf_health_ammo_rifle_head", "0", "步枪击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountRifleAmmoShot		= CreateConVar("l4d2_Kill_inf_health_ammo_rifle_shot", "0", "步枪爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountShotgunAmmoHead	= CreateConVar("l4d2_Kill_inf_health_ammo_shotgun_head", "0", "单喷击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountShotgunAmmoShot	= CreateConVar("l4d2_Kill_inf_health_ammo_shotgun_shot", "0", "单喷爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountSmgAmmoHead		= CreateConVar("l4d2_Kill_inf_health_ammo_smg_head", "0", "冲锋枪击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountSmgAmmoShot		= CreateConVar("l4d2_Kill_inf_health_ammo_smg_shot", "0", "冲锋枪爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountSniperAmmoHead	= CreateConVar("l4d2_Kill_inf_health_ammo_sniperrifle_head", "0", "狙击枪击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountSniperAmmoShot	= CreateConVar("l4d2_Kill_inf_health_ammo_sniperrifle_shot", "0", "狙击枪爆头击杀一个特感奖励多少前置弹药(不包括坦克). 0=禁用.", FCVAR_NOTIFY);
	hCountKIHrevive		= CreateConVar("l4d2_Kill_revive_health", "0", "救起倒地的幸存者奖励多少血. 0=禁用提示和血量奖励.", FCVAR_NOTIFY);
	hCountKIHTank			= CreateConVar("l4d2_Kill_tank_health", "0", "杀死坦克的幸存者奖励多少血. 0=禁用提示和血量奖励.", FCVAR_NOTIFY);
	hCountKIHrescued		= CreateConVar("l4d2_Kill_rescued_health", "0", "营救队友的幸存者奖励多少血. 0=禁用提示和血量奖励.", FCVAR_NOTIFY);
	hCountKIHhealk			= CreateConVar("l4d2_Kill_heal_health", "0", "治愈队友的幸存者奖励多少血. 0=禁用提示和血量奖励.", FCVAR_NOTIFY);
	hCountKIHused			= CreateConVar("l4d2_Kill_sed_health", "0", "电击器复活队友的幸存者奖励多少血. 0=禁用提示和血量奖励.", FCVAR_NOTIFY);
	hCountKIHWitch			= CreateConVar("l4d2_Kill_witch_health", "0", "击杀女巫的幸存者奖励多少血. 0=禁用提示和血量奖励.", FCVAR_NOTIFY);
	hCountKIHWitchShot		= CreateConVar("l4d2_Kill_witch_health_2", "0", "秒杀女巫的幸存者奖励多少血. 0=禁用提示和血量奖励.", FCVAR_NOTIFY);
...
public void HealSuccess(Event event, const char[] name, bool dontBroadcast)
{
	...
	if (CountKIHenabled == 1 && l4d2_HLReturnset)
	{
		...
		if (GetClientTeam(client) == 2)
		{
			if (HLReturnset)
			{
				if (IsPlayerAlive(subject) && !IsPlayerFallen(subject))
				{
					int Attackerhealth = GetClientHealth(client);
					int tmphealth = L4D_GetPlayerTempHealth(client);
					int iMaxHealth = GetEntProp(subject, Prop_Send, "m_iMaxHealth");
