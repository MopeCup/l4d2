...
public void OnPluginStart()
{
	...
	g_hCvarNotify =			CreateConVar(	"l4d_gear_transfer_notify",			"0",			"0=Off, 1=Display transfers to everyone, 2=Also display when transferring pills/adrenaline via the games own system, 4=Display between recipients only. 8=Ignore printing pills/adrenaline and use game prompt only. Add numbers together.", CVAR_FLAGS);
	...
	g_hCvarTimerGive =		CreateConVar(	"l4d_gear_transfer_timer_give",		"10.0",			"0.0=Off. How often to check survivor bot positions to real clients for auto give.", CVAR_FLAGS, true, 0.0, true, 10.0);
